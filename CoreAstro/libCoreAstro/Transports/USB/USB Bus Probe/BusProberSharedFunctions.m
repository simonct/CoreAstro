...
NSString * VendorNameFromVendorID(NSString * intValueAsString) {
    ...
    if (gVendorNamesDictionary == nil) {
        gVendorNamesDictionary = [NSMutableDictionary dictionary];
...
NSString * GetUSBProductNameFromRegistry(io_registry_entry_t entry) {
	...
	return (__bridge_transfer NSString *) IORegistryEntryCreateCFProperty(	entry, CFSTR(kUSBProductString), kCFAllocatorDefault, 0);
